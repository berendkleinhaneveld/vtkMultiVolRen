/*=========================================================================
  ...
  Module:    vtkOpenGLGPUVolumeRayCastMapper2.cxx
...
=========================================================================*/
#include "vtkOpenGLGPUVolumeRayCastMapper2.h"
...
extern const char *vtkGPUVolumeRayCastMapper2_CompositeFS;
...
vtkStandardNewMacro(vtkOpenGLGPUVolumeRayCastMapper2);
  ...
  void Update(vtkPiecewiseFunction *scalarOpacity,
              ...
              bool linearInterpolation)
    {
      ...
      if(scalarOpacity->GetMTime() > this->BuildTime ||
        ...
        vtkOpenGLGPUVolumeRayCastMapper2::PrintError("1d opacity texture is too large");
        this->Loaded=true;
  ...
  void Update(vtkColorTransferFunction *scalarRGB,
              ...
              bool linearInterpolation)
    {
      ...
      if(scalarRGB->GetMTime() > this->BuildTime
        ...
        vtkOpenGLGPUVolumeRayCastMapper2::PrintError("1d RGB texture is too large");
        this->Loaded=true;
        this->BuildTime.Modified();
        this->LastRange[0] = range[0];
        this->LastRange[1] = range[1];
          ...
          if(this->Loaded)
            ...
            if(this->Loaded)
              ...
              if(errorCode!=GL_NO_ERROR)
                ...
                cout<<vtkOpenGLGPUVolumeRayCastMapper2::OpenGLErrorMessage(static_cast<unsigned int>(errorCode));
                cout<<endl;
                }
              ...
              if(this->Loaded)
                ...
                if(needTypeConversion)
                  ...
                  if(1) // !this->SupportsPixelBufferObjects)
                    ...
                    vtkOpenGLGPUVolumeRayCastMapper2::PrintError("genbuffer");
                    vtkgl::BindBuffer(vtkgl::PIXEL_UNPACK_BUFFER,pbo);
                    vtkOpenGLGPUVolumeRayCastMapper2::PrintError("binbuffer");
                    ...
                    vtkgl::BufferData(vtkgl::PIXEL_UNPACK_BUFFER,texSize,dataPtr,
                                      vtkgl::STREAM_DRAW);
                    vtkOpenGLGPUVolumeRayCastMapper2::PrintError("bufferdata");
                    vtkgl::TexImage3D(vtkgl::TEXTURE_3D, 0, internalFormat,
                                      textureSize[0],textureSize[1],textureSize[2],
                                      0,format,type,0);
                    vtkOpenGLGPUVolumeRayCastMapper2::PrintError("teximage3d");
                    vtkgl::BindBuffer(vtkgl::PIXEL_UNPACK_BUFFER,0);
                    vtkOpenGLGPUVolumeRayCastMapper2::PrintError("bindbuffer to 0");
                    vtkgl::DeleteBuffers(1,&pbo);
                    }
                  vtkOpenGLGPUVolumeRayCastMapper2::PrintError("3d texture is too large2");
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::CheckFrameBufferStatus()
{
  GLenum status;
...
//-----------------------------------------------------------------------------
vtkStdString vtkOpenGLGPUVolumeRayCastMapper2::BufferToString(int buffer)
{
  vtkStdString result;
...
// ----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::DisplayReadAndDrawBuffers()
{
  GLint value;
...
//
// ----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::DisplayFrameBufferAttachments()
{
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::DisplayFrameBufferAttachment(
...
// not be null.
//-----------------------------------------------------------------------------
const char *vtkOpenGLGPUVolumeRayCastMapper2::OpenGLErrorMessage(
...
// message if any.
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::PrintError(const char *headerMessage)
{
  GLenum errorCode=glGetError();
  if(errorCode!=GL_NO_ERROR)
    {
...
//-----------------------------------------------------------------------------
vtkOpenGLGPUVolumeRayCastMapper2::vtkOpenGLGPUVolumeRayCastMapper2()
{
...
//
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::IsRenderSupported(
...
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::TestRequiredExtension(
...
//     any failure codes
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::LoadExtensions(
  vtkRenderWindow *window)
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::ReleaseGraphicsResources(
  vtkWindow *window)
{
...
// will be 1.
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::CreateOpenGLObjects(vtkRenderer *ren)
{
  GLint value;
...
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::AllocateFrameBuffers(vtkRenderer *ren)
{
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::GetTextureFormat(
  vtkImageData *input,
...
//-----------------------------------------------------------------------------
bool vtkOpenGLGPUVolumeRayCastMapper2::TestLoadingScalar(
  unsigned int internalFormat,
  unsigned int format,
  unsigned int type,
  int textureSize[3],
...
//                           textureExtent[4]<=textureExtent[5])))
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::LoadScalarField(vtkImageData *input,
...
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::UpdateColorTransferFunction(
  vtkVolume *vol,
...
// \pre valid_numberOfScalarComponents: numberOfScalarComponents==1 || numberOfScalarComponents==4
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::UpdateOpacityTransferFunction(
  vtkVolume *vol,
  int numberOfScalarComponents,
  unsigned int level)
{
...
// \pre vol_exists: vol!=0
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::SetupRender(vtkRenderer *ren,
                                                    vtkVolume *vol)
{
  assert("pre: ren_exists" && ren!=0);
  assert("pre: vol_exists" && vol!=0);
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::DebugDisplayBox(vtkPolyData *box)
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::ClipBoundingBox(vtkRenderer *ren,
...
//
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::RenderClippedBoundingBox(
  int tcoordFlag,
  size_t currentBlock,
...
// ----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::CopyFBOToTexture()
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::CleanupRender()
{
  glPopMatrix();
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::BuildScaleBiasProgram(vtkRenderWindow *w)
{
  if(this->ScaleBiasProgram==0)
    {
...
// \pre ren_exists: ren!=0
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::RenderTextureToScreen(vtkRenderer *ren)
{
  assert("pre: ren_exists" && ren!=0);
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::ComputeReductionFactor(
...
//   - numberOfLevels >= 1
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::PreRender(vtkRenderer *ren,
                                                vtkVolume *vol,
...
//-----------------------------------------------------------------------------
double vtkOpenGLGPUVolumeRayCastMapper2::ComputeMinimalSampleDistancePerPixel(
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::RenderBlock(vtkRenderer *ren,
                                                    vtkVolume *vol,
                                                    unsigned int level)
{
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::PostRender(
  vtkRenderer *ren,
  int numberOfScalarComponents)
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::GPURender(vtkRenderer *ren,
                                                  vtkVolume *vol)
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::RenderWholeVolume(vtkRenderer *ren,
                                                          vtkVolume *vol)
{
  double volBounds[6];
...
//
//-----------------------------------------------------------------------------
extern "C" int vtkRegionComparisonFunction2(const void *x,
                                           const void *y)
{
...
// \pre this->ProgramShader!=0 and is linked.
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::RenderRegions(vtkRenderer *ren,
                                                      vtkVolume *vol)
{
  double bounds[27][6];
  double distance2[27];
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::ComputeNumberOfCroppingRegions()
{
  this->NumberOfCroppingRegions=0;
  if(this->Cropping)
    {
...
// corresponding axis.
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::SlabsFromDatasetToIndex(
...
// corresponding axis.
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::SlabsFromIndexToDataset(
  double slabsPoints[6],
  double slabsDataSet[6])
{
  double *spacing=this->GetInput()->GetSpacing();
...
// \pre this->ProgramShader!=0 and is linked.
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::RenderSubVolume(vtkRenderer *ren,
                                                       double bounds[6],
                                                       vtkVolume *volume)
{
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::LoadProjectionParameters(
  vtkRenderer *ren,
  vtkVolume *vol)
{
  vtkMatrix4x4 *worldToDataset=vol->GetMatrix();
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::BuildProgram(vtkRenderWindow *w,
  ...
  if(raycastMethod!=this->LastRayCastMethod)
    ...
    switch(raycastMethod)
      ...
      case vtkOpenGLGPUVolumeRayCastMapperMethodComposite:
        methodCode=vtkGPUVolumeRayCastMapper2_CompositeFS;
        break;
...
//
//-----------------------------------------------------------------------------
const char *vtkOpenGLGPUVolumeRayCastMapper2::GetEnabledString(
  unsigned char value)
{
  if(value)
    {
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::GetOpenGLState()
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::GetLightingStatus()
{
  //cout<<"lighting: ";
...
//-----------------------------------------------------------------------------
int vtkOpenGLGPUVolumeRayCastMapper2::PowerOfTwoGreaterOrEqual(int x)
{
...
//
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::UpdateNoiseTexture()
{
  if(this->NoiseTextureId==0)
    {
...
void vtkOpenGLGPUVolumeRayCastMapper2::GetReductionRatio(double ratio[3])
{
...
//-----------------------------------------------------------------------------
void vtkOpenGLGPUVolumeRayCastMapper2::PrintSelf(ostream& os,
                                                  vtkIndent indent)
{
