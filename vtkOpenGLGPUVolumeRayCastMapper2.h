/*=========================================================================
  ...
  Module:    vtkOpenGLGPUVolumeRayCastMapper2.h
...
=========================================================================*/
// .NAME vtkOpenGLGPUVolumeRayCastMapper2 - OpenGL subclass that draws the
// image to the screen
// .SECTION Description
...
#ifndef __vtkOpenGLGPUVolumeRayCastMapper2_h
#define __vtkOpenGLGPUVolumeRayCastMapper2_h
...
class VTKRENDERINGVOLUMEOPENGL_EXPORT vtkOpenGLGPUVolumeRayCastMapper2
  : public vtkGPUVolumeRayCastMapper
{
public:
  static vtkOpenGLGPUVolumeRayCastMapper2 *New();
  vtkTypeMacro(vtkOpenGLGPUVolumeRayCastMapper2,vtkGPUVolumeRayCastMapper);
...
protected:
  vtkOpenGLGPUVolumeRayCastMapper2();
  ~vtkOpenGLGPUVolumeRayCastMapper2();
...
private:
  vtkOpenGLGPUVolumeRayCastMapper2(const vtkOpenGLGPUVolumeRayCastMapper2&);  // Not implemented.
  void operator=(const vtkOpenGLGPUVolumeRayCastMapper2&);  // Not implemented.
};
